 ...
 */
//代码，名称，规格，总库存，单位
public class HomeListRyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public HomeListRyAdapter(Context context, ArrayList<ConnectResponseBean.DataBaseList> items) {
        this.items = items;
...
//                    }
    ...
    public void setOnItemClickListener(HomeListRyAdapter.OnItemClickListener listener) {
