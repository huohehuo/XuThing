...
public class BaseDataRyAdapter extends RecyclerArrayAdapter<BuyBean> {
    Context context;
    public BaseDataRyAdapter(Context context) {
        super(context);
    }
//    @Override
...
//        }
    ...
    class MarkHolder extends BaseViewHolder<BuyBean> {
...
//
//    class MarkHolderForDate extends BaseViewHolder<BuyBean> {
//
//        private TextView name;
//        private TextView time;
