...
import com.lins.xuthing.RxSerivce.CloudService;
import com.lins.xuthing.RxSerivce.RService;
import com.lins.xuthing.Utils.BasicShareUtil;
import com.lins.xuthing.Utils.Config;
...
//        builder.retryOnConnectionFailure(true);
        ...
        okHttpClient = new OkHttpClient.Builder()
                ...
                .connectTimeout(5580, TimeUnit.SECONDS)
                .readTimeout(880, TimeUnit.SECONDS)
                .writeTimeout(880, TimeUnit.SECONDS)
                .build();
