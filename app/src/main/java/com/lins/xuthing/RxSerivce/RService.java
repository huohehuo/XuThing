package com.lins.xuthing.RxSerivce;
...
import com.lins.xuthing.BuildConfig;
import com.lins.xuthing.Utils.BasicShareUtil;
...
public class RService {
    ...
    public void getCodeCheckData(String json, MySubscribe<CommonResponse> mySubscribe) {
        toSubscribe(request.getCodeCheckData(getParams(json)), mySubscribe);
    }
    public void getCodeCheckInsert(String json, MySubscribe<CommonResponse> mySubscribe) {
        toSubscribe(request.getCodeCheckInsert(getParams(json)), mySubscribe);
    }
    public void getCodeCheckDataForOut(String json, MySubscribe<CommonResponse> mySubscribe) {
        toSubscribe(request.getCodeCheckDataForOut(getParams(json)), mySubscribe);
    }
    public void getCodeCheckDataForOutForRed(String json, MySubscribe<CommonResponse> mySubscribe) {
        toSubscribe(request.getCodeCheckDataForOutForRed(getParams(json)), mySubscribe);
    }
    public void getCodeCheckInsertForOut(String json, MySubscribe<CommonResponse> mySubscribe) {
        toSubscribe(request.getCodeCheckInsertForOut(getParams(json)), mySubscribe);
    }
    public void getCodeCheckInsertForOutForRed(String json, MySubscribe<CommonResponse> mySubscribe) {
        toSubscribe(request.getCodeCheckInsertForOutForRed(getParams(json)), mySubscribe);
    }
    public void getCodeCheckDataForPD(String json, MySubscribe<CommonResponse> mySubscribe) {
        toSubscribe(request.getCodeCheckDataForPD(getParams(json)), mySubscribe);
    }
    public void getCodeCheckDataForIn(String json, MySubscribe<CommonResponse> mySubscribe) {
        toSubscribe(request.getCodeCheckDataForIn(getParams(json)), mySubscribe);
    }
    public void getCodeCheckInsertForIn(String json, MySubscribe<CommonResponse> mySubscribe) {
        toSubscribe(request.getCodeCheckInsertForIn(getParams(json)), mySubscribe);
    }

    public void getCodeCheckDelete(String json, MySubscribe<CommonResponse> mySubscribe) {
        toSubscribe(request.getCodeCheckDelete(getParams(json)), mySubscribe);
    }
    public void getProductForId(String json, MySubscribe<CommonResponse> mySubscribe) {
        toSubscribe(request.getProductForId(getParams(json)), mySubscribe);
    }
    public void getPackageUpload(String json, MySubscribe<CommonResponse> mySubscribe) {
        toSubscribe(request.getPackageUpload(getParams(json)), mySubscribe);
    }

    public void getCodeStateCheck(String json, MySubscribe<CommonResponse> mySubscribe) {
        toSubscribe(request.getCodeStateCheck(getParams(json)), mySubscribe);
    }
    public void getOrderCodeUpdate(String json, MySubscribe<CommonResponse> mySubscribe) {
        toSubscribe(request.getOrderCodeUpdate(getParams(json)), mySubscribe);
    }
    public void deleteAllDetailTable(String json, MySubscribe<CommonResponse> mySubscribe) {
        toSubscribe(request.deleteAllDetailTable(getParams(json)), mySubscribe);
    }
