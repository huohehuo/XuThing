...
import com.lins.xuthing.Beans.BackOrderQuery;
import com.lins.xuthing.Beans.BackOrderResult;
import com.lins.xuthing.Beans.CommonResponse;
import com.lins.xuthing.Beans.OrderQuery;
import com.lins.xuthing.Beans.OrderQueryResult;
import com.lins.xuthing.Beans.SendOrderQuery;
import com.lins.xuthing.Beans.SendOrderResult;
...
interface ServiceRequest {
    ...
    @FormUrlEncoded
    @POST("CodeCheck")
    Observable<CommonResponse> getCodeCheckData(@FieldMap Map<String, String> params);

    @FormUrlEncoded
    @POST("CodeCheckInsert")
    Observable<CommonResponse> getCodeCheckInsert(@FieldMap Map<String, String> params);

    @FormUrlEncoded
    @POST("CodeCheckForIn")
    Observable<CommonResponse> getCodeCheckDataForIn(@FieldMap Map<String, String> params);

    @FormUrlEncoded
    @POST("CodeCheckInsertForIn")
    Observable<CommonResponse> getCodeCheckInsertForIn(@FieldMap Map<String, String> params);

    @FormUrlEncoded
    @POST("CodeCheckForOut")
    Observable<CommonResponse> getCodeCheckDataForOut(@FieldMap Map<String, String> params);

    @FormUrlEncoded
    @POST("CodeCheckForOutForRed")
    Observable<CommonResponse> getCodeCheckDataForOutForRed(@FieldMap Map<String, String> params);

    @FormUrlEncoded
    @POST("CodeCheckInsertForOut")
    Observable<CommonResponse> getCodeCheckInsertForOut(@FieldMap Map<String, String> params);

    @FormUrlEncoded
    @POST("CodeCheckInsertForOutForRed")
    Observable<CommonResponse> getCodeCheckInsertForOutForRed(@FieldMap Map<String, String> params);

    @FormUrlEncoded
    @POST("CodeCheckForPD")
    Observable<CommonResponse> getCodeCheckDataForPD(@FieldMap Map<String, String> params);


    @FormUrlEncoded
    @POST("CodeCheckDelete")
    Observable<CommonResponse> getCodeCheckDelete(@FieldMap Map<String, String> params);


    @FormUrlEncoded
    @POST("ProductSearchWhere")
    Observable<CommonResponse> getProductForId(@FieldMap Map<String, String> params);

    @FormUrlEncoded
    @POST("PackageUpload")
    Observable<CommonResponse> getPackageUpload(@FieldMap Map<String, String> params);


    @FormUrlEncoded
    @POST("CodeStateCheck")
    Observable<CommonResponse> getCodeStateCheck(@FieldMap Map<String, String> params);

    //当单据生成新的ordercode的时候，更新服务器的临时表之前的ordercode
    @FormUrlEncoded
    @POST("OrderCodeUpdate")
    Observable<CommonResponse> getOrderCodeUpdate(@FieldMap Map<String, String> params);

    @FormUrlEncoded
    @POST("DetailTableDeleteAll")
    Observable<CommonResponse> deleteAllDetailTable(@FieldMap Map<String, String> params);
    ...
    @POST("{actionio}")
    Observable<OrderQueryResult> getOrderQuery(@Path("actionio") String io, @Body OrderQuery params);

    @POST("{actionio}")
    Observable<SendOrderResult> getOrderQuery(@Path("actionio") String io, @Body SendOrderQuery params);

    @POST("{actionio}")
    Observable<BackOrderResult> getBackOrderQuery(@Path("actionio") String io, @Body BackOrderQuery params);
