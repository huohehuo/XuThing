...
public class Config {
    ...
    public static String Company="上海集团";
    ...
    public static final int ShouLiao2OutsourcingISActivity          =10031;
    /*-----------------------------------------------------------------------------*/
    public static final int DsCheckActivity                         =10032;
    public static final int PushDownSo2SoActivity                   =10033;
    public static final int PD4YCLActivity                          =10034;
    public static final int DsCheckBackActivity                     =10035;
    public static final int PackageNowActivity                      =10036;
