...
public class InStorageNumListBean {
    public ArrayList<inStoreList> list;
    public class inStoreList{
        ...
        public void setFSecQty(String FSecQty) {
            this.FSecQty = FSecQty;
        }

        public String getFSecUnit() {
            return FSecUnit;
        }

        public void setFSecUnit(String FSecUnit) {
            this.FSecUnit = FSecUnit;
        }
